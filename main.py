...
from app.db import get_db_and_tables  # Імпортуємо функцію ініціалізації БД

@asynccontextmanager
async def lifespan(app: FastAPI):
    await get_db_and_tables()  # Ініціалізуємо базу даних і створюємо таблиці
    yield  # Після цього застосунок готовий обробляти запити
